...
export default function ServicosComponent (){
    return(
        <div className="flex justify-around py-[30px] px-[30px] space-x-[20px] bg-black">
            <div className="relative">
                <img src="/Bordados.png" className="rounded-[30px]"></img>
                <motion.svg className="absolute top-0 left-0 right-0 m-auto" width="257" height="24" viewBox="0 0 257 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <motion.path
                ...
                <h2 className="text-white uppercase absolute top-0 left-0 right-0 text-center">Bordados</h2>
            </div>

            <div className="relative">
                <img src="/DFT.png" className="rounded-[30px]"></img>
                <motion.svg className="absolute top-0 left-0 right-0 m-auto" width="314" height="70" viewBox="0 0 314 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path
                    initial={{ pathLength: 0 }}
                    animate={{ pathLength: 1 }}
                ...
                <h2 className="text-white uppercase absolute top-0 left-0 right-0 text-center">Impressão DFT</h2>
            </div>

            <div className="relative">
                <img src="/Sublimacao.png" className="rounded-[30px]"></img>
                <motion.svg className="absolute top-0 left-0 right-0 m-auto" width="193" height="557" viewBox="0 0 193 557" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path
                    initial={{ pathLength: 0 }}
                    animate={{ pathLength: 1 }}
                ...
                <h2 className="text-white uppercase absolute top-0 left-0 right-0 text-center">Impressão Sublimação</h2>
            </div>

            <div className="relative">
                <img src="/Serigrafia.png" className="rounded-[30px]"></img>
                <motion.svg className="absolute top-0 left-0 right-0 m-auto" width="305" height="100" viewBox="0 0 305 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path 
                    initial={{ pathLength: 0 }}
                    animate={{ pathLength: 1 }}
                ...
                <h2 className="text-white uppercase absolute top-0 left-0 right-0 text-center">Serigrafia</h2>
            </div>

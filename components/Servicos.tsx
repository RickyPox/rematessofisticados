    ...
    return(
        <div className="grid grid-cols-2 gap-[10px] md:flex justify-around py-[30px] px-[30px] md:space-x-[20px] bg-black">
            <div className="relative flex justify-center items-center">
                <div className="imgContainer md:rounded-[30px]">
                    <img src="/Bordados.png" className="md:rounded-[30px] rounded-[10px]"></img>
                </div>
                
                <motion.svg ref={ref} className="absolute top-[50%] left-0 right-0 m-auto w-[90%] pointer-events-none" width="257" height="24" viewBox="0 0 257 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <motion.path
                        initial={"hidden"}
                        animate={controls}
                ...
                <h2 className="text-white uppercase absolute top-[50%] -translate-y-[50%] left-0 right-0 text-center px-[10px] pointer-events-none">Bordados</h2>
            </div>

            <div className="relative">
            <div className="imgContainer md:rounded-[30px]">
                <img src="/DFT.png" className="md:rounded-[30px] rounded-[10px]"></img>
            </div>
                <motion.svg className="absolute top-[50%] -translate-y-[50%] left-0 right-0 m-auto w-[90%] pointer-events-none" width="314" height="70" viewBox="0 0 314 70" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path
                    initial={"hidden"}
                    animate={controls}
                    variants={svgVariants}
                ...
                <h2 className="text-white uppercase absolute top-[50%] -translate-y-[50%] left-0 right-0 text-center px-[10px] pointer-events-none">Impressão DFT</h2>
            </div>
            ...
            <div className="imgContainer md:rounded-[30px]">
                ...
                <motion.svg className="absolute -translate-y-[50%] top-[50%] left-0 right-0 m-auto h-[90%] w-[90%] pointer-events-none" width="193" height="557" viewBox="0 0 193 557" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path
                    initial={"hidden"}
                    animate={controls}
                    variants={svgVariants}
                ...
                <h2 className="text-white uppercase absolute top-[50%] -translate-y-[50%] left-0 right-0 text-center px-[10px] pointer-events-none">Impressão Sublimação</h2>
            </div>
            ...
            <div className="imgContainer md:rounded-[30px]">
                ...
                <motion.svg className="absolute top-[50%] -translate-y-[50%] left-0 right-0 m-auto  w-[90%] pointer-events-none" width="305" height="100" viewBox="0 0 305 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <motion.path 
                    initial={"hidden"}
                    animate={controls}
                    variants={svgVariants}
                ...
                <h2 className="text-white uppercase absolute top-[50%] -translate-y-[50%] left-0 right-0 text-center px-[10px] pointer-events-none" >Serigrafia</h2>
            </div>

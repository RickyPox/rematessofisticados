...
export default function Home() {
  return (
    <div className="w-screen">
      ...
      <div className="circle w-[580px] h-[580px] rounded-full absolute opacity-50 blur-[100px]"/>
      ...
      autoFill = {true}>
        <div className="py-[10px] ">
          <div className="flex space-x-[20px] py-[10px] border-t-[1px] border-white border-b-[1px] marquee-container">
            <h2 className="uppercase text-white">Ambiciosos</h2>
            <h2 className="uppercase text-white">Audazes</h2>
            <h2 className="uppercase text-white">Arrojados</h2>
          </div>
        </div>
      </Marquee>
